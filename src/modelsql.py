...
def db(name,id1,id2):
    print("Welcome",name,"Your ID:-",id_)
    values =(id_,name,today)
...
def fireb(ID1):
    Name1 = name
    #FBConn = firebase.FirebaseApplication('https://fir-test-10952.firebaseio.com',None)
    
   
    
    #FBConn.post('/DATABASE5/',data_to_upload)
